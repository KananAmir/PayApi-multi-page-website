      ...
      <div className="pricingInfo">
        <div className="pricingItems">
          ...
          <div className="pricingList">
            <img src={checked} alt="checked"/> <p>Transactions</p> <br />
            <img src={checked} alt="checked"/> <p>Auth</p> <br />
            <img src={checked} alt="checked"/> <p>Identity</p> <br />
        ...
        <div className="pricingItems">
          ...
          <div className="pricingList">
            ...
            <img src={checked} alt="checked"/> <p>Auth</p> <br />
            <img src={checked} alt="checked"/> <p>Identity</p> <br />
            <img src={checked} alt="checked"/> <p>Investments</p> <br />
            <img src={checked} alt="checked"/> <p>Assets</p> <br />
            <p className="unclicked">Liabilities</p> <br />
            <p className="unclicked">Income</p> <br />
            <hr />
            <button className="requestButton"> Request Acces</button>
        ...
        <div className="pricingItems">
          ...
          <div className="pricingList">
            ...
            <img src={checked} alt="checked"/> <p>Investments</p> <br />
            <img src={checked} alt="checked"/> <p>Assets</p> <br />
            <img src={checked} alt="checked"/> <p>Liabilities</p> <br />
            <img src={checked} alt="checked"/> <p>Income</p> <br />
            <hr />
            <button className="requestButton"> Request Acces</button>
          </div>
        </div>
