        ...
        return (
            <div className="about">
                ...
                <div className="about-content">
                    ...
                    <p className="about-content-parag">Our main goal is to build beautiful consumer experiences along with developer-friendly infrastructure. The result is an intelligent tool that gives everyone the ability to create amazing products that solve big problems.
                ...
                <div className="about-content">
                    ...
                    <p className="about-content-parag">At the core of our platform is the technical infrastructure APIs that connect consumers. Our innovative product provides key insights for businesses and individuals, 
                        as well as robust reporting for traditional financial institutions and developers.</p>
                </div>

                <img className="mobile-about-img" src={mobile_about_img} alt="team members"/>
                <img className="tablet-about-img" src={tablet_about_img} alt="team members"/>
                <img className="desktop-about-img" src={desktop_about_img} alt="team members"/>
                ...
                <div className="about-content">
                    ...
                    <p className="about-content-parag">We strongly believe there's always an opportunity to learn from each other outside of day-to-day work, whether it's company-wide offsites, internal hackathons, or co-worker meetups. We always value cross-team collaboration and diversity of thought, 
                    no matter the job title.</p>
                </div>  

                <div className="about-content">
                    <h3 className="about-content-heading">The People</h3>
                    <p className="about-content-parag"> We're all passionate about building a more efficient and inclusive financial infrastructure together. 
